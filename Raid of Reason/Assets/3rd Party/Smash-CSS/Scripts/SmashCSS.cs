...
public class SmashCSS : MonoBehaviour {
    ...
    public CharacterInfo confirmedCharacter;
    ...
    private void SpawnCharacterCell(CharacterInfo character)
    {
    ...
    public void ShowCharacterInSlot(int player, CharacterInfo character)
    {
    ...
    public void ConfirmCharacter(int player, CharacterInfo character)
    {
